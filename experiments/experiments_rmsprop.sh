python main.py --path "/home/user/code/data/tf_data" --model FlatCNN --model_size small --data MNIST --dtype float64 --optimizer RMSPROP --batch_size 3000 --gpu 11 --run_eagerly --max_epochs 50000 --use_wandb --max_calls 10985

python main.py --path "/home/user/code/data/tf_data" --model FlatCNN --model_size large --data MNIST --dtype float64 --optimizer RMSPROP --batch_size 3000 --gpu 11 --run_eagerly --max_epochs 50000 --use_wandb --max_calls 10985
