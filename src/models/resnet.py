...
class ResNetTypeI(tf.keras.Model):
    def __init__(self, layer_params, num_classes):
        ...
        self.layer1 = make_basic_block_layer(num_filters=8,
                                             blocks=layer_params[0])
        self.layer2 = make_basic_block_layer(num_filters=16,
                                             blocks=layer_params[1],
                                             stride=2)
        self.layer3 = make_basic_block_layer(num_filters=32,
                                             blocks=layer_params[2],
                                             stride=2)
        self.layer4 = make_basic_block_layer(num_filters=64,
