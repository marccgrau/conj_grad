...
def _load_svhn(data_config: DataConfig):
    """
    ...
    # ensure all images have same size
    resizer = tf.keras.layers.Resizing(*_IMAGE_SIZE_SVHN)
...
def fetch_data(
    ...
    if lowercase_name == "mnist":
        ...
        return ds_train, ds_test
    elif lowercase_name == "svhn":
        ds_train, ds_test = _load_svhn(data_config)
        return ds_train, ds_test
    else:
        return
